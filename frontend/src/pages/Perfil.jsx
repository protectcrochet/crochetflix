...
const PRECIOS = {
  ...
  ARS: { mensual: '$8,130',    anual: '$73,092',     label: 'ARS' },
  BRL: { mensual: 'R$29.21',   anual: 'R$291.99',    label: 'BRL' },
  BYN: { mensual: 'Br15.91',   anual: 'Br158.99',    label: 'BYN' },
  CAD: { mensual: 'CA$7.97',   anual: 'CA$71.63',    label: 'CAD' },
  CLP: { mensual: '$5,149',    anual: '$46,285',     label: 'CLP' },
  COP: { mensual: '$20,908',   anual: '$187,966',    label: 'COP' },
  CRC: { mensual: '₡2,610',    anual: '₡23,466',     label: 'CRC' },
  DOP: { mensual: 'RD$341',    anual: 'RD$3,061',    label: 'DOP' },
  EUR: { mensual: '€4.95',     anual: '€44.52',      label: 'EUR' },
  GBP: { mensual: '£4.29',     anual: '£38.54',      label: 'GBP' },
  GTQ: { mensual: 'Q43.90',    anual: 'Q394.70',     label: 'GTQ' },
  PEN: { mensual: 'S/19.65',   anual: 'S/196.99',    label: 'PEN' },
  RUB: { mensual: '₽408',      anual: '₽4,076',      label: 'RUB' },
  USD: { mensual: 'US$5.99',   anual: 'US$49.99',    label: 'USD' },
};
